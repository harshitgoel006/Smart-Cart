...
const GroceriesTopBrands = () => {
  return (
    <section className="relative py-20 overflow-hidden">
      ...
      {/* LIGHT BACKGROUND GLOW (Freshness Palette) */}
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          >
            Sourced directly from the most trusted names in food and household essentials.
          </motion.p>
        </div>
            ...
            >
              ...
              >
                <img
                  ...
                  alt={brand.name}
                  className="
                    h-12 w-auto max-w-[70%] object-contain
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Explore 200+ organic and local brands for your kitchen.
              </p>
            </div>
...
export default GroceriesTopBrands;