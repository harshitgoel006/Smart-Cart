    ...
    <section className="w-full pt-2 pb-20 overflow-hidden">
      <motion.div
        ...
        className="
          ...
          bg-gradient-to-br from-[#061e14] via-[#020d08] to-[#1a2e26]
          rounded-none md:rounded-none
          shadow-[0_10_20px_-20px_rgba(0,0,0,0.8)]
        "
      >
        {/* AMBIENT GLOWS (EMERALD & GOLD) */}
        <div className="absolute top-[-10%] left-[-5%] w-[40%] h-[40%] bg-emerald-900/15 blur-[120px] rounded-full animate-pulse" />
        <div className="absolute bottom-[-10%] right-[-5%] w-[40%] h-[40%] bg-amber-900/10 blur-[120px] rounded-full animate-pulse" />
        ...
        <div className="relative z-30 text-center px-6 max-w-4xl mx-auto">
          ...
          >
            <div className="w-2 h-2 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-full animate-ping" />
            <span className="text-[10px] md:text-xs font-black tracking-[0.5em] text-emerald-300 uppercase">
              Curated Spaces 2026
            </span>
          </motion.div>
          ...
          <div className="overflow-hidden space-y-2 mb-8">
            ...
            <motion.h2
              ...
              className="text-xl md:text-4xl lg:text-5xl font-black italic bg-gradient-to-r from-emerald-400 via-teal-400 to-amber-400 bg-clip-text text-transparent"
            >
          ...
          >
            ...
            <span className="font-bold text-white">UPTO 60% OFF</span>
          </motion.p>
          ...
          >
            <Link
              ...
              hover:shadow-emerald-500/30 transition-all duration-500 hover:-translate-y-1"
            >
              Redefine Home
              <FiArrowRight className="group-hover:translate-x-2 transition-transform" />
              <span className="absolute inset-0 bg-gradient-to-r from-emerald-500/20 via-transparent to-teal-500/20 opacity-0 group-hover:opacity-100 transition-all duration-700 rounded-3xl" />
            </Link>
          </motion.div>
        </div>
...
export default HomeLivingExclusivePromo;