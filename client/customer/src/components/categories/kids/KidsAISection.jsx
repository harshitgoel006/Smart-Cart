...
const slides = [
  {
    ...
    highlight: "Playful Precision",
    desc: "No more guessing sizes. Our AI ensures the perfect fit for your growing little ones with fun and ease.",
    image: "https://i.pinimg.com/1200x/51/04/82/510482e4def49df5918cd00957181f67.jpg",
    accent: "from-orange-400 to-yellow-500",
  },
  {
    id: 2,
    title: "Style Adventures",
    highlight: "Kid Approved",
    desc: "Discover outfits that match their energy. AI-powered recommendations for every playground adventure.",
    image: "https://i.pinimg.com/1200x/3d/df/06/3ddf06b30dc286ecba08374d2d497a71.jpg",
...
const KidsAISection = () => {
  ...
  shadow-[0_15px_15px_rgba(0,0,0,0.12),0_15px_15px_rgba(0,0,0,0.08)]">
        <Swiper
          ...
          className="kids-ai-swiper h-[500px] md:h-[700px] w-full"
        >
          {slides.map((slide) => (
                ...
                <div className="relative z-20 w-full px-8 md:px-24">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-8 bg-white/5 backdrop-blur-xl px-4 py-2 rounded-full border border-white/10 w-fit shadow-xl">
                      <div className="h-2 w-2 rounded-full bg-yellow-400 animate-pulse shadow-[0_0_10px_#facc15]" />
                    ...
                    <div className="mt-10 flex items-center gap-8">
                      ...
                      <button className="flex items-center gap-2 text-white/40 hover:text-white transition-all text-[11px] font-bold uppercase tracking-widest group">
                        Specs <FiChevronRight className="group-hover:translate-x-2 transition-transform" />
                      </button>
                    </div>
                  </motion.div>
                </div>
      ...
      <style jsx global>{`
        .kids-ai-swiper .swiper-pagination {
        ...
        .kids-ai-swiper .swiper-pagination-bullet {
        ...
        .kids-ai-swiper .swiper-pagination-bullet-active {
