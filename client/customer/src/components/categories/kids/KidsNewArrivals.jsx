...
const products = [
  {
    ...
    rating: 4.8,
    badge: "Trending",
    image: "https://i.pinimg.com/736x/ce/d2/9f/ced29f5b29a886b3a69b2aaacd158c9b.jpg",
  },
  {
    id: 102,
    name: "Blue Jumpsuit",
    ...
    rating: 4.9,
    badge: "Limited",
    image: "https://i.pinimg.com/1200x/eb/60/a7/eb60a7b1624205bbee8afe133e6c4c40.jpg",
  },
  {
    id: 103,
    name: "Sharara Set",
    ...
    rating: 4.7,
    badge: "New Era",
    image: "https://i.pinimg.com/1200x/81/48/dc/8148dc3ba330b5333061afe571da0b56.jpg",
  },
  {
    id: 104,
    name: "Yellow T-Shirt",
          ...
          {products.map((p, i) => (
            ...
            >
              ...
              <div className="relative aspect-[4/5] overflow-hidden rounded-[2.5rem] bg-gray-50 border border-gray-100 shadow-[0_12px_30px_rgba(0,0,0,0.08)] group-hover:shadow-[0_40px_80px_-20px_rgba(147,51,234,0.35)]">
                ...
                {/* CATEGORY */}
                <Link
                  to={`/products?category=kids&type=${p.category.toLowerCase()}`}
...
export default KidsNewArrivals;