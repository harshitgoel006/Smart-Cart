...
const categories = [
  {
    title: "Co-ord Sets",
    highlight: "Matching Magic",
    discount: "UP TO 80% OFF",
    link: "/products?category=kids&sub=coords",
    bg: "bg-[#FFF7ED]", // Soft Orange/Peach
    shadow: "group-hover:shadow-orange-200",
    mainImage: "https://i.pinimg.com/1200x/3b/dd/f5/3bddf5fc8215faff9f90f84b56e4ec52.jpg",
    minis: [
      "https://i.pinimg.com/1200x/a5/70/74/a5707451974cefa671b47564a2494eb8.jpg",
      "https://i.pinimg.com/1200x/ef/cf/d2/efcfd235af3771afde5244d456793075.jpg",
    ],
  },
  {
    title: "Ethnic Froks",
    highlight: "Little Princess",
    discount: "UP TO 45% OFF",
    link: "/products?category=kids&sub=ethnic",
    bg: "bg-[#FDF2F8]", // Soft Pink
    shadow: "group-hover:shadow-pink-200",
    mainImage: "https://i.pinimg.com/1200x/d4/a8/7c/d4a87c96213080546e0995a0fcba6ae7.jpg",
    minis: [
      "https://i.pinimg.com/736x/04/6b/32/046b32babe89dbce5e6c945061837b05.jpg",
      "https://i.pinimg.com/736x/3e/1b/41/3e1b419fce4272422bcf33692103f5e0.jpg",
    ],
  },
  {
    title: "Baby Sets",
    highlight: "Tiny Comfort",
    discount: "UP TO 50% OFF",
    link: "/products?category=kids&sub=infant",
    bg: "bg-[#F0FDFA]", // Soft Teal/Mint
    shadow: "group-hover:shadow-teal-200",
    mainImage: "https://i.pinimg.com/736x/ef/1b/fc/ef1bfca0199a9825ac85b25c30212487.jpg",
    minis: [
      "https://i.pinimg.com/1200x/c0/fe/f1/c0fef14cc62a5b8ac8fbea8c9ce66322.jpg",
      "https://i.pinimg.com/1200x/6c/66/58/6c6658c1ced3c5945f8e7131621be7bf.jpg",
    ],
  },
];
    ...
    <section className="pt-0 pb-18 overflow-hidden ">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-10">
          ...
          >
            <p className="text-[10px] font-black tracking-[0.5em] text-orange-600 uppercase mb-4">
              Playful Selections
            </p>

            <h2 className="text-4xl md:text-5xl font-black leading-[1.1] tracking-tighter text-gray-900">
              Kids' <span className="italic font-extralight text-gray-300">Daily</span>
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 via-pink-600 to-purple-500">
                Collections
              </span>
            </h2>
          </motion.div>
          ...
          <Link
            to="/all-products?category=kids"
            className="group relative overflow-hidden flex items-center gap-4 text-[10px] font-black uppercase tracking-[0.3em] bg-gray-950 text-white px-10 py-5 rounded-full hover:bg-orange-600 transition-colors duration-500"
          >
            <span className="relative z-10">View Little Drops</span>
...
export default KidsPromoCategories;