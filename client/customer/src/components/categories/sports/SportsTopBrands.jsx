    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          >
            The gear used by professionals. Discover excellence from the world's leading sports giants.
          </motion.p>
        </div>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <h3 className="text-3xl font-bold text-white mb-2">
                Hunting for a specific lab?
              </h3>
              <p className="text-gray-400">
                Explore our full catalog of 50+ specialized equipment brands.
              </p>
            </div>
...
export default SportsTopBrands;