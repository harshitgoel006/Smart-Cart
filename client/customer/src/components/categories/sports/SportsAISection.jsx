...
const slides = [
  {
    ...
    desc: "Unlock your potential with AI-driven gear recommendations that adapt to your kinetic movement and power.",
    image: "https://i.pinimg.com/736x/85/b9/bc/85b9bc7fd6957b46c8878ad435b84e8a.jpg",
    accent: "from-purple-400 to-indigo-500",
  },
  {
    id: 2,
    title: "Neural Motion Tech",
    highlight: "Precision Gear",
    desc: "Maximize every rep. Our AI engine analyzes your activity data to find the perfect equipment for your goals.",
    image: "https://i.pinimg.com/1200x/25/e5/79/25e57974528307d6847b335449f9046f.jpg",
...
const SportsAISection = () => {
  ...
  shadow-[0_15px_15px_rgba(0,0,0,0.12),0_15px_15px_rgba(0,0,0,0.08)]">
        <Swiper
          ...
          className="sports-ai-swiper h-[500px] md:h-[700px] w-full"
        >
          {slides.map((slide) => (
                    ...
                    <div className="mt-10 flex items-center gap-8">
                      ...
                      >
                        <span className="relative z-10 flex items-center gap-3 group-hover:text-white transition-colors duration-500">
                          Try AI Coach <FiZap className="fill-current" />
                        </span>
                      ...
                      <button className="flex items-center gap-2 text-white/40 hover:text-white transition-all text-[11px] font-bold uppercase tracking-widest group">
                        Lab Specs <FiChevronRight className="group-hover:translate-x-2 transition-transform" />
                      </button>
                    </div>
                  </motion.div>
                </div>
      ...
      <style jsx global>{`
        .sports-ai-swiper .swiper-pagination {
        ...
        .sports-ai-swiper .swiper-pagination-bullet {
        ...
        .sports-ai-swiper .swiper-pagination-bullet-active {
...
export default SportsAISection;