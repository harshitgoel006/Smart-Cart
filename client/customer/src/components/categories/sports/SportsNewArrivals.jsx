...
const products = [
  {
    id: 1,
    name: "Carbon Pro Runners",
    category: "Footwear",
    price: 8499,
    mrp: 12000,
    rating: 4.9,
    badge: "Trending",
    image: "https://i.pinimg.com/1200x/13/e6/a0/13e6a0425ffeef6232d9243e39882d0b.jpg",
  },
  {
    id: 2,
    ...
    rating: 4.8,
    badge: "Limited",
    image: "https://i.pinimg.com/1200x/22/94/8f/22948f67e51171b93fb1b27f0cac585d.jpg",
  },
  {
    id: 3,
    ...
    rating: 4.7,
    badge: "New Era",
    image: "https://i.pinimg.com/736x/25/19/6c/25196c858ce070c3e2522322e3a9ee7c.jpg",
  },
  {
    id: 4,
          ...
          {products.map((p, i) => (
            ...
            >
              ...
              <div className="relative aspect-[4/5] overflow-hidden rounded-[2.5rem] bg-gray-50 border border-gray-100 shadow-[0_12px_30px_rgba(0,0,0,0.08)] group-hover:shadow-[0_40px_80px_-20px_rgba(147,51,234,0.35)]">
                ...
                {/* CATEGORY */}
                <Link
                  to={`/products?category=sports&type=${p.category.toLowerCase()}`}
...
export default SportsNewArrivals;