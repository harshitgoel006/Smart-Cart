    ...
    <section className="w-full pt-2 pb-20 overflow-hidden">
      <motion.div
        ...
        className="
          ...
          bg-gradient-to-br from-[#1a0f0f] via-[#0a0a0a] to-[#2e1a1a]
          rounded-none md:rounded-none
          shadow-[0_10_20px_-20px_rgba(0,0,0,0.8)]
        "
      >
        {/* AMBIENT GLOWS - Warmer Tones for Gifting */}
        <div className="absolute top-[-10%] left-[-5%] w-[40%] h-[40%] bg-rose-900/15 blur-[120px] rounded-full animate-pulse" />
        <div className="absolute bottom-[-10%] right-[-5%] w-[40%] h-[40%] bg-orange-900/15 blur-[120px] rounded-full animate-pulse" />
        ...
        <div className="relative z-30 text-center px-6 max-w-4xl mx-auto">
          ...
          >
            <div className="w-2 h-2 bg-gradient-to-r from-rose-400 to-orange-400 rounded-full animate-ping" />
            <span className="text-[10px] md:text-xs font-black tracking-[0.5em] text-rose-300 uppercase">
              Curated Moments 2026
            </span>
          </motion.div>
          ...
          <div className="overflow-hidden space-y-2 mb-8">
            ...
            <motion.h2
              ...
              className="text-xl md:text-4xl lg:text-5xl font-black italic bg-gradient-to-r from-rose-400 via-purple-400 to-orange-400 bg-clip-text text-transparent"
            >
              Made Thoughtful
            </motion.h2>
          </div>
          ...
          >
            ...
            >
              ...
              <span className="absolute inset-0 bg-gradient-to-r from-rose-500/20 via-transparent to-orange-500/20 opacity-0 group-hover:opacity-100 transition-all duration-700 rounded-3xl" />
            </Link>
          </motion.div>
        </div>
...
export default GiftsExclusivePromo;