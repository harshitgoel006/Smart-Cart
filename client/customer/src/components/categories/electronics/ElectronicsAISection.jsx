...
const slides = [
  {
    id: 1,
    title: "AI Tech Intelligence",
    highlight: "The Smart Ecosystem",
    desc: "Why scroll endlessly? Let SmartCart's neural engines curate a tech ecosystem tailored to your lifestyle.",
    image: "https://i.pinimg.com/736x/ce/3e/1a/ce3e1a80d869dcdd1c2c2b744a511645.jpg",
    accent: "from-blue-400 to-cyan-500",
  },
  {
    id: 2,
    title: "Virtual Specs Lab",
    highlight: "Future Performance",
    desc: "Experience pro-grade gadgets. Our AI analyzes your usage patterns to recommend the perfect performance gear.",
...
const ElectronicsAISection = () => {
  ...
  shadow-[0_15px_15px_rgba(0,0,0,0.12),0_15px_15px_rgba(0,0,0,0.08)]">
        <Swiper
          ...
          className="elec-ai-swiper h-[500px] md:h-[700px] w-full"
        >
          {slides.map((slide) => (
                  ...
                  >
                    ...
                    <div className="mt-10 flex items-center gap-8">
                      ...
                      <button className="flex items-center gap-2 text-white/40 hover:text-white transition-all text-[11px] font-bold uppercase tracking-widest group">
                        Compare <FiChevronRight className="group-hover:translate-x-2 transition-transform" />
                      </button>
                    </div>
                  </motion.div>
                </div>
      ...
      <style jsx global>{`
        .elec-ai-swiper .swiper-pagination {
        ...
        .elec-ai-swiper .swiper-pagination-bullet {
        ...
        .elec-ai-swiper .swiper-pagination-bullet-active {
...
export default ElectronicsAISection;