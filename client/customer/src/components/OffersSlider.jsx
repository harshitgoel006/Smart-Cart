...
//   const prev = () =>
//     setActive((p) => (p === 0 ? offers.length - 1 : p - 1));

//   return (
//     <section className="relative w-full h-[520px] md:h-[650px] overflow-hidden group">
...
//             >
//               <span className="inline-block mb-6 px-4 py-1 rounded-full bg-purple-600 text-[10px] font-black tracking-[0.3em] uppercase">
//                 {offers[active].badge}
//               </span>
...
//               <h3 className="mt-2 text-3xl md:text-5xl font-black text-purple-400">
...
//                   className="px-10 py-4 bg-white text-gray-900 font-black rounded-2xl
//                              hover:bg-purple-600 hover:text-white transition-all
//                              transform hover:scale-105 shadow-2xl flex items-center gap-2"
//                 >
//                   {offers[active].cta}
//                   <FiArrowRight />
//                 </Link>
...
//                 <Link
//                   to="/offers"
//                   className="hidden md:inline-block font-bold text-white/80 hover:text-white underline underline-offset-8"
//                 >
//                   View all offers
//                 </Link>
//               </div>
...
//         <button
//           onClick={prev}
//           className="pointer-events-auto w-12 h-12 rounded-full bg-white/10 backdrop-blur-md
//                      border border-white/20 text-white flex items-center justify-center
//                      hover:bg-white hover:text-black transition-all
//                      opacity-0 group-hover:opacity-100 -translate-x-5 group-hover:translate-x-0"
//         >
  ...
  return (
    <section className="relative w-full h-[550px] md:h-[680px] overflow-hidden group bg-black">
      ...
      <div className="absolute inset-y-0 left-0 right-0 flex items-center justify-between px-8 pointer-events-none">
        <button
          onClick={prev}
          className="pointer-events-auto w-14 h-14 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 text-white flex items-center justify-center hover:bg-white/20
 hover:bg-white/20 transition-all opacity-0 group-hover:opacity-100 -translate-x-10 group-hover:translate-x-0 shadow-2xl"
        >
