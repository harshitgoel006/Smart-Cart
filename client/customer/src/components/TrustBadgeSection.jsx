...
// const BadgeCard = ({ icon, title, delay }) => {
...
//       <div className="absolute -inset-4 bg-indigo-500/5 rounded-[3rem] opacity-0 group-hover:opacity-100 blur-2xl transition-opacity duration-500" />
      
//       <div className="relative w-64 h-72 bg-white border border-gray-100 rounded-[3rem] flex flex-col items-center justify-center p-8 shadow-[0_20px_50px_rgba(0,0,0,0.04)] group-hover:shadow-[0_40px_80px_rgba(79,70,229,0.1)] transition-all duration-500">
        
//         {/* Animated Icon Container */}
//         <motion.div 
//           style={{ translateZ: 50 }}
//           className="w-24 h-24 rounded-full bg-pink-50 flex items-center justify-center mb-8 relative"
//         >
//           {/* Subtle rotating ring */}
//           <div className="absolute inset-0 rounded-full border-2 border-dashed border-pink-200 animate-[spin_15s_linear_infinite] opacity-0 group-hover:opacity-100 transition-opacity" />
          
//           <div className="text-4xl text-pink-500 transition-all duration-500 group-hover:scale-110 group-hover:rotate-[360deg]">
//             {icon}
//           </div>
//         </motion.div>
...
//         <motion.h3 
//           style={{ translateZ: 40 }}
//           className="text-gray-900 font-bold tracking-tight text-lg text-center"
//         >
//           {title}
//         </motion.h3>

//         {/* Progress-style bottom bar */}
//         <div className="absolute bottom-6 w-12 h-1 bg-gray-100 rounded-full overflow-hidden">
//           <div className="w-full h-full bg-pink-600 scale-x-0 group-hover:scale-x-100 transition-transform duration-700 origin-left" />
//         </div>
//       </div>
//     </motion.div>
//   );
...
//   const badges = [
//     { icon: <FiRefreshCw />, title: "Easy Exchange" },
//     { icon: <FiHeart />, title: "100% Handpicked" },
//     { icon: <FiCheckCircle />, title: "Assured Quality" },
//   ];

//   return (
//     <section className="w-full py-28 bg-white flex flex-col items-center justify-center overflow-hidden">
//       <div className="flex flex-wrap justify-center gap-10 md:gap-16 px-6">
//         {badges.map((badge, idx) => (
//           <BadgeCard key={idx} {...badge} delay={idx * 0.1} />
//         ))}
//       </div>
//     </section>
//   );
