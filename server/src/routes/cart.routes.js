// This module defines the routes for cart-related operations in the application. It includes routes for both customer and admin panels, allowing customers to manage their cart items and apply coupons, while providing admins with analytics and coupon management capabilities. Each route is protected by authentication and role-based authorization middleware to ensure that only authorized users can access the respective functionalities. The controller functions imported at the top handle the business logic for each route, interacting with the database and performing necessary operations based on the request parameters and body.
