// This module defines the Mongoose schemas and model for the shopping cart functionality in the e-commerce application. It includes a CartItem schema that represents individual items in the cart, and a Cart schema that represents the entire shopping cart associated with a user. The Cart schema includes methods to calculate totals based on the items in the cart, and indexes to optimize queries related to users and products in the cart.
...
cartSchema.methods.calculateTotals = function () {
  ...
  this.finalAmount = mongoose.Types.Decimal128.fromString(final.toFixed(2));
};
